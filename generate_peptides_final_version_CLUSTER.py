...
#======================================================================
#======================================================================
# The following script EXTRACTS ONLY the CDS entries from the GTF file;
...
class SequenceExtractor:
    ...
    def add_exon_sequences(
        ...
        for _, can_row in canonical_df.iterrows():
            ...
            strand_gene = exons["strand"].iloc[0]
            strand_h38.append(strand_gene)
